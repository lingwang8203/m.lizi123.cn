$(document).ready(function(){
  ...
  $.ajax({
    type:"post",
    url:"http://qj_api.qdmedia.cc/index.php/home/club/clubApplyList",
    data:{
    	"club_id":club_id,
    },
...
function applyPass(id){
  ...
  if (id) {
    $.ajax({
        type:"post",
        url:"http://qj_api.qdmedia.cc/index.php/home/club/applyPass",
        data:{
          "club_id":club_id,
          "id":id,
        },
...
function resShow(obj){
  ...
  if (obj.length>0) {
    for (var i = 0; i < obj.length; i++) {
      ...
      html += "<img src='"+obj[i].member_info.user_image+"' class='touxiang'/>";
