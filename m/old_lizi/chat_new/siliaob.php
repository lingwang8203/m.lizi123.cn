   ...
   <div id="eventReply" style="display:none" ></div><br />
    ...
    <!-- 新版界面 -->
		...
		<div class="chat_dilan">
            ...
            <div id="biaoqinglan">
				<div class="hang">
					<img src="img/gif_picture/F_1.gif" class="biaoqing"/>
					<img src="img/gif_picture/F_2.gif" class="biaoqing"/>
					<img src="img/gif_picture/F_3.gif" class="biaoqing"/>
					<img src="img/gif_picture/F_4.gif" class="biaoqing"/>
					<img src="img/gif_picture/F_5.gif" class="biaoqing"/>
					<img src="img/gif_picture/F_6.gif" class="biaoqing"/>
					<img src="img/gif_picture/F_7.gif" class="biaoqing"/>
				</div>
				<div class="hang">
					<img src="img/gif_picture/F_8.gif" class="biaoqing"/>
					<img src="img/gif_picture/F_9.gif" class="biaoqing"/>
