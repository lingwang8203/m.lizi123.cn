$(document).ready(function(){
	...
	$.ajax({
        type:"post",
        url:"http://api.lizi123.cn/index.php/home/user/managePageClub",
        data:{
        	//"user_id":user_id,
        },
        success:function(data){
            ...
            if(obj.status==200){	
                for (var i = 0; i < obj.length; i++) {
					...
					html += "</div>";
					html += "<a href='manage_club.html?club_id="+obj[i].club_id+"'><span class='manage_label'>管理社团</span></a>";
					html += "<a href='../page_club/page_club.html?club_id="+obj[i].club_id+"'><span class='juti'>></span></a>";
					html += "</div>";
					html += "</div>";
					html += "</a>";
