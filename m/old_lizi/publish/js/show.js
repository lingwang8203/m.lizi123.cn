...
document.getElementById("furnish").addEventListener("touchstart",function(e){
	e.preventDefault();
	var check=true;
	if(document.getElementById("tupian").style.display=="none")
		check=false;
	if(document.getElementById("content").value.length>140){
		alert("内容字数在140字以内");
		check=false;
	}
...
document.getElementById("weizhi").addEventListener("touchstart",showPosition(),false);