...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
   ...
   <!-- <link rel="stylesheet" href="home.css">
    ...
    <style>
        ...
        .main2-begin{
        	position: absolute;top: 20px;z-index: -1;opacity: 0;
        }

        .main2-end{
        	top: 0px;opacity: 1;z-index:1;
        }
        .main1-end{
        	transform: translateY(-1000px);opacity: 0;z-index:-1;
        }
...
<div class="container main1" id="main1">
    ...
    <div class="box" style="margin-top:30px;">
        <input id="chooseImage" class="btn" type="button" value="选择多张照片"></input>
    </div>
</div>
<div class="container main2-begin" id="main2">
	<div class="box">
		<img src="images/boolean.png" width="100%" height="auto">
	</div>
</div>
...
<script>
    ...
    $(document).ready(function ()
    {
        ...
        ws = new WebSocket("ws://qjwa.qdmedia.cc:15001");  //每个app 端口不一样
        ws.onopen = function() {
...
//wx.ready(function ()
        ...
        var shareData = {
            title: 'Tokyo街头夹拖',
            desc: '个性化夹拖打印',
            link: 'http://jtym.qdmedia.cc/index.php?pcid=1000&openid=oxhfpwH5di1dxI8ZyWM3tqqjoRwM',
