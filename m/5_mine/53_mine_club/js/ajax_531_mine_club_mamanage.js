	...
	if (obj.status==200) {
		for (var i = 0; i < obj.length; i++) {
            ...
            html+="<a href='http://m.lizi123.cn/2_function/22_function_club/222_function_club_concret.html?club_id="+obj[i].id+"' target='_blank'>";
	   		...
	   		html+="<a href='http://m.lizi123.cn/3_publish/34_publish_club/343_publish_club_Manage.html?club_id="+obj[i].id+"'><div class='aui-pull-right aui-label lab aui-font-size-12 aui-label-outlined tap_on' style='margin-top: 0.1rem;'>进入管理</div></a>";
	   		html+="<a href='http://m.lizi123.cn/2_function/22_function_club/222_function_club_concret.html?club_id="+obj[i].id+"' target='_blank'>";
