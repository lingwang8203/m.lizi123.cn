$(document).ready(function(){
	$("#Manage_class_list").text("");
	$.ajax({
		type:"post",
		url:"http://api.lizi123.cn/index.php/home/class/joinClassList",
        async:false,
		xhrFields: {
			...
			console.dir(obj);
  			if (obj.status==200) {
  				for(var i=0;i<obj.length;i++){
			        ...
			        html+="<a href='http://m.lizi123.cn/6_chat/siliao.php?user_id="+obj[i].id+"'><div class='aui-pull-right aui-label lab aui-font-size-12 aui-label-outlined tap_on' style='margin-top: 0;'>联系讲师</div></a>";
			        html+="</div></div></li><div class='aui-hr'></div>";
  					$("#Manage_class_list").append(html);
  				}
