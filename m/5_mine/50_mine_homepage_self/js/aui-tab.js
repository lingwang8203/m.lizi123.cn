        	...
        	if(tabItems){
        		...
        		for(var i=0; i<tabItems.length; i++){
        			...
        			tabItems[i].onclick = function(e){
            			...
            			if(this.id=="frame1")
            			{document.getElementById("ifram").src="501_mine_homepage_self_frame1.html";}
            			else if(this.id=="frame2")
            			{document.getElementById("ifram").src="502_mine_homepage_self_frame2.html";}          
            			else if(this.id=="frame3")
            			{document.getElementById("ifram").src="503_mine_homepage_self_frame3.html";}              			
        			}
        		}
        	}
        },
