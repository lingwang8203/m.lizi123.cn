					...
					var obj = eval(data);
 	  				if (obj.status==200) {
 	  					for(var i=0;i<obj.length;i++){
	            			...
	            			html+="<a target='_blank' href='13_home_label/13_home_tag.html?tag_id="+obj[i].tag_id+"'><div class='aui-label aui-pull-right aui-font-size-12 tap' style='position: absolute;top: 0.5rem;right: 0;'>"+obj[i].tag_name+"</div></a>";
	            			...
	            			html+="</div><a href='../2_function/24_function_show/241_function_show_concret.html?show_id="+obj[i].id+"'><div class='aui-col-xs-2 aui-row aui-margin-l-5 aui-pull-left'><i class='aui-iconfont aui-icon-comment'></i><span class='aui-font-size-12' style='padding-left:4px !important;'>"+obj[i].comment_num+"</span>";
