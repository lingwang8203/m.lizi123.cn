        	...
        	if(tabItems){
        		...
        		for(var i=0; i<tabItems.length; i++){
        			...
        			tabItems[i].onclick = function(e){
            			...
            			if(this.id=="frame1")
            			{document.getElementById("ifram").src="511_mine_homepage_frame1.html";}
            			else if(this.id=="frame2")
            			{document.getElementById("ifram").src="512_mine_homepage_frame2.html";}          
            			else if(this.id=="frame3")
            			{document.getElementById("ifram").src="513_mine_homepage_frame3.html";}              			
        			}
        		}
        	}
        },
