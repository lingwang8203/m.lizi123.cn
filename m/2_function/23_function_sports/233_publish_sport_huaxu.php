...
<head>
	...
	<script src="js/ajax_233_publish_sport_huaxu.js"></script>
	<style type="text/css">
		.aui-list textarea{
			height: 9rem;
		}
...
<body>
	<!--顶部，发布活动-->
		<header class="aui-bar aui-bar-nav aui-bar-light aui-bg-base" style="color: #212121 !important;">
		    ...
		    <div class="aui-title aui-font-size-20">发布活动花絮</div>
	            ...
	            <li class="aui-list-item">
		            <div class="aui-list-item-inner">
		                <div class="aui-list-item-input">
		                    <textarea placeholder="记录活动的精彩瞬间" id="content" maxlength="140"></textarea>
		                </div>
		            </div>
		        </li>
		   </ul>
