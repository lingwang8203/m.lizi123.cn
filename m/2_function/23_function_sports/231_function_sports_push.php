...
<html>
	<head>
	    ...
	    <script src="js/ajax_function_sports_push.js"></script>
	...
	<div class="aui-content"style="width: 100%;padding-top: 0.2rem;">
   		 <p class="aui-pull-left tit">活动分类</p>
	</div>	
	<div class="aui-row"style="width: 100%;padding-bottom: 0.2rem;">
		<div class="aui-col-xs-4 aui-text-center">
			<div class="aui-label tap_nor aui-font-size-12 aui-col-xs-12 " name="function_sports_label"></div>	
			<div class="aui-label tap_nor aui-font-size-12  aui-col-xs-12" name="function_sports_label"></div>	
		</div>
		<div class="aui-col-xs-4 aui-text-center">
			<div class="aui-label tap_nor aui-font-size-12  aui-col-xs-12" name="function_sports_label"></div>	
