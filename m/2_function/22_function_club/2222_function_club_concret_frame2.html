...
<body>
	<div class="aui-list" id="club_xiu_list">
		<!----------------------秀秀推送格式（一图）-------------->
		<!--<li class="aui-row aui-padded-b-5 aui-padded-t-5" style="width:100%;background: white;">
			...
			<div class="aui-col-xs-6 aui-row aui-padded-t-5">
				...
				<div class="aui-col-12 aui-font-size-12"style="color: #414141;">"越努力越幸福，相信自己!"</div>
			</div>
			<div class="aui-col-xs-4 aui-font-size-12" style="margin-top: 0.3rem;color: #9E9E9E;">
			<div class="aui-pull-right aui-padded-r-5">3小时前</div></div>
			<a href="../24_function_show/241_function_show_concret.html"target="_blank">
			...
			<div class="aui-row aui-col-xs-12">
				<div class="aui-col-xs-2 aui-row aui-margin-l-15 aui-pull-left">
					<i class="aui-iconfont aui-icon-like" name="club_xiu_zan_index"></i>
...
<!----------------------秀秀推送格式(3图)-------------->
		<!--<li class="aui-row aui-padded-b-5 aui-padded-t-5"style="width:100%;background: white;">
			...
			<a href="../2_function/24_function_show/241_function_show_concret.html.html" target="_blank">
    ...
    <!--<div class="aui-card-list">
        <div class="aui-card-list-header aui-card-list-user aui-border-b">
            <div class="aui-card-list-user-avatar">
                <img src="http://lizi-img.oss-cn-shenzhen.aliyuncs.com/new_lizi/2_function/22_function_club/touxiang2.jpg" class="aui-img-round" />
            </div>
            <div class="aui-card-list-user-name">
                <div>韶华嫣然。</div>
            </div>
            <div class="aui-card-list-user-info">花开花落花满天，红绡香断有谁怜。<small class="aui-pull-right">一小时前</small></div>
        </div>
        <div class="aui-card-list-content-padded">
            <img src="http://lizi-img.oss-cn-shenzhen.aliyuncs.com/new_lizi/2_function/22_function_club/ShowCard2.jpg" />
        </div>
        <div class="aui-card-list-content-padded">
                         世界上只有一种英雄主义,就是看清生活的真相之后依然热爱生活。"Il n'ya qu'un héroïsme au monde : c'est de voir le monde tel qu'il est et de l'aimer.
        </div>
        <div class="aui-card-list-footer aui-border-t">
            <div><i class="aui-iconfont aui-icon-like"></i><span class="aui-font-size-14">198</span> <i class="aui-iconfont aui-icon-comment"> <span class="aui-font-size-14">208</span></i></div>
        </div>
    </div>-->
	<!--</div>-->
