        	...
        	if(tabItems){
        		...
        		for(var i=0; i<tabItems.length; i++){
        			...
        			tabItems[i].onclick = function(e){
            			...
            			document.getElementById("ifram").style.height="37em";
            			document.getElementById("publish_class_ganwu").style.display="none";}
            			else if(this.id=="frame2"&&edit_index==0)
            			{document.getElementById("ifram").src="3222_publish_class_Manage_frame2.html?class_id="+class_id;
            			document.getElementById("ifram").style.height="75em";
