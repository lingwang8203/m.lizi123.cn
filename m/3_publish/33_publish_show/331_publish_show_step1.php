...
<head>
	...
	<link rel="stylesheet" href="css/new_publish_show.css" />
	<script src="js/ajax_publish_show_step1.js"></script>
	<style type="text/css">
		.aui-list textarea{
			height: 9rem;
		}
...
<body>
	<!--顶部，发布活动-->
	<div id="loadimg" style="display:none; position: fixed; z-index: 200;top: 0; left:0;background:#f3f8ff;opacity:0.8;filter:alpha(opacity=80);width: 100%;height: 100%;">
		<div style="width: 120px;height: 120px;margin: 50% auto;">
			<img src="http://img.lizi123.cn/new_lizi/2_function/loadimg.gif" style="width: 120px;height: 120px;">				
		</div>
	</div>
		<header class="aui-bar aui-bar-nav aui-bar-light aui-bg-base" style="color: #212121 !important;">
		    ...
		    <div class="aui-title aui-font-size-20">发布秀秀</div>
		    <button class="aui-pull-right aui-btn" style="color: #212121 !important;" id="furnish">下一步</button>
		</header>
	            ...
	            <li class="aui-list-item">
		            <div class="aui-list-item-inner">
		                <div class="aui-list-item-input">
		                    <textarea placeholder="展示你的独特之处" id="content" maxlength="140"></textarea>
		                </div>
		            </div>
		        </li>
		   </ul>
