        	...
        	if(tabItems){
        		...
        		for(var i=0; i<tabItems.length; i++){
        			...
        			tabItems[i].onclick = function(e){
            			...
            			if(this.id=="else")
            			{document.getElementById("ifram").src="312301_publish_sports_step2_Manage_frame3_publishLatest_frame1.php";}
            			else if(this.id=="vote")
            			{document.getElementById("ifram").src="312302_publish_sports_step2_Manage_frame3_publishLatest_frame2.html";}                     			
        			}
        		}
        	}
        },
